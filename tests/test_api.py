...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        u = User(email='testing@gmail.com', password='cat', confirmed=True,
                 role=r)
        db.session.add(u)
        db.session.commit()
        ...
        response = self.client.get(
            '/api/v1/posts/',
            headers=self.get_api_headers('testing@gmail.com', 'dog'))
        self.assertEqual(response.status_code, 401)
    ...
    def test_token_auth(self):
        ...
        response = self.client.post(
            '/api/v1/tokens/',
            headers=self.get_api_headers('testing@gmail.com', 'cat'))
    ...
    def test_unconfirmed_account(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u = User(email='testing@gmail.com', password='cat', confirmed=False,
                 role=r)
        db.session.add(u)
        db.session.commit()
    ...
    def test_users(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u1 = User(email='testing@gmail.com', username='test',
                  password='cat', confirmed=True, role=r)
        u2 = User(email='testing2@gmail.com', username='test2',
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('testing2@gmail.com', 'dog'))
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.get_data(as_text=True))
        ...
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.get_data(as_text=True))
        self.assertEqual(json_response['username'], 'test2')
